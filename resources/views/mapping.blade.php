...
// /home/karthickaravindan/Documents/Project/network_graph
    var DIR="{{ asset('mapping_profling/output/')}}"
    var DIR_FACE="{{ asset('mapping_profling/video/video-1/person/') }}"

    var JAY_1_DIR="{{ asset('mapping_profling/output-1/output-1/jay-1/') }}"
    var JAY_1_DIR_FACE="{{ asset('mapping_profling/output-1/video/jay-1/face/') }}"

    var JAY_2_DIR="{{ asset('mapping_profiling/output-1/output-1/jay-2/') }}"
    var JAY_2_DIR_FACE="{{ asset('mapping_profling/output-1/video/jay-2/face/') }}"
